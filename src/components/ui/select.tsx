...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-11 w-full items-center justify-between rounded-xl border text-foreground placeholder:text-muted-foreground ring-offset-background transition-all duration-200 ease-in-out shadow-glass-soft outline-none",
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        position === "popper" && "w-[var(--radix-select-trigger-width)]", // Set Content width to trigger width for popper
        className
      )}
      position={position}
      {...props}
    >
      ...
      <SelectPrimitive.Viewport
        className={cn(
          "p-1",
          position === "popper" && "w-full" // Viewport takes full width of parent. Height auto.
        )}
      >
        {children}
      </SelectPrimitive.Viewport>
